        ...
        <div ref={ref} style={{ fontSize: 13, color: '#0f172a' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 8 }}>
            <table style={{ borderCollapse: 'collapse', minWidth: 300 }}><tbody>
              <tr><td style={{ padding: '4px 10px', color: '#475569' }}>Sub Total</td><td style={{ padding: '4px 10px', textAlign: 'right' }}>{formatCurrency(invoice.sub_total)}</td></tr>
              <tr><td style={{ padding: '4px 10px', color: '#475569' }}>HST (13%)</td><td style={{ padding: '4px 10px', textAlign: 'right' }}>{formatCurrency(invoice.tax_total)}</td></tr>
          ...
          <div style={{ marginTop: 16, borderTop: '1px solid #eef0f5', paddingTop: 12, fontSize: 11.5, color: '#475569' }}>
            <div style={{ fontWeight: 700, color: '#334155' }}>{co.deposit_heading || 'Deposit Instructions'}</div>
            <div>Beneficiary Name : {co.bank_beneficiary}</div>
            <div>Bank Name: {co.bank_name} · Transit: {co.transit_no} · Account: {co.account_no} · Institution: {co.institution_no}</div>
            <div style={{ marginTop: 8, fontWeight: 700 }}>HST Number : {co.hst_number}</div>
          </div>
