...
export default function ChangePasswordModal({ open, onClose }: ChangePasswordModalProps) {
  ...
  const [form, setForm] = useState<ChangePasswordForm>({ current_password: '', password: '', password_confirmation: '' });
  ...
  const save = async () => {
    ...
    try {
      ...
      toast(first || apiErrorMessage(e, 'Could not change password'), 'bad');
      setSaving(false);
    }
  };
