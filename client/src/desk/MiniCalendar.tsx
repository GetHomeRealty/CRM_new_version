...
export default function MiniCalendar({ selected = [], onToggle }: MiniCalendarProps) {
  const now = new Date();
...
const navBtn: CSSProperties = { border: '1px solid var(--line)', background: '#fff', borderRadius: 6, width: 24, height: 24, cursor: 'pointer', lineHeight: 1 };
