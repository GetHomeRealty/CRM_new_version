...
export const IMPORT_FIELDS: ImportField[] = [
  ...
  { column: 'Deal Status', key: 'status', type: 'text', hint: 'Must be valid for the transaction type (see the Reference sheet). Listing types default to Active if left blank; every other type needs one entered.', example: 'Open' },
