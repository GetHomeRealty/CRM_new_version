...
class UpdateTransactionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'buyer_lawyer_name' => ['sometimes', 'nullable', 'string', 'max:255'],
            'buyer_lawyer_email' => ['sometimes', 'nullable', 'email', 'max:255'],
            'buyer_lawyer_phone' => ['sometimes', 'nullable', 'string', 'max:50'],
            'buyer_lawyer_address' => ['sometimes', 'nullable', 'string', 'max:255'],
            'seller_lawyer_name' => ['sometimes', 'nullable', 'string', 'max:255'],
            'seller_lawyer_email' => ['sometimes', 'nullable', 'email', 'max:255'],
            'seller_lawyer_phone' => ['sometimes', 'nullable', 'string', 'max:50'],
            'seller_lawyer_address' => ['sometimes', 'nullable', 'string', 'max:255'],
